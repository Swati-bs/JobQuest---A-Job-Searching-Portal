...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = '------------'  # Replace with your Google Client ID
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = ''  # Replace with your Google Client Secret
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Local file system path for storing media files
